...
from lib.pointnet import PointNetfeat, STN3d
...
class PoseNetFeat(nn.Module):
    ...
    def forward(self, x, emb):
        ...
        return torch.cat([fusion, ap_x], 1)  # 256 + 1024 + 64
...
class PoseNet(nn.Module):
    def __init__(self, num_points, num_obj):
        ...
        self.conv1_r = torch.nn.Conv1d(1344, 640, 1)
        self.conv1_t = torch.nn.Conv1d(1344, 640, 1)
        self.conv1_c = torch.nn.Conv1d(1344, 640, 1)
